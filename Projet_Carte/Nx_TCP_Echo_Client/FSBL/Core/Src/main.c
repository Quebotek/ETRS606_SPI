...
int main(void)
{
  ...
  /* Laisse le temps au Mac de se connecter */
    HAL_Delay(2000);

    /* Débloque le buffer printf pour le Mac */
...
/**
  * @brief  Retargets the C library printf function to the USART (GCC Specific).
  * Sans cette fonction, printf ne sait pas où envoyer les octets sous STM32CubeIDE.
  */
int _write(int file, char *ptr, int len)
{
  /* On envoie tout le bloc de caractères d'un coup pour plus d'efficacité */
...
/**
  * @brief  Retargets the C library printf function to the USART (Autre méthode).
  */
PUTCHAR_PROTOTYPE
{
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.LimitAddress = 0x3404FFFF;  /* 320 Ko */
  MPU_InitStruct.AttributesIndex = MPU_ATTRIBUTES_NUMBER0;  /* non-cacheable */
  MPU_InitStruct.AccessPermission = MPU_REGION_ALL_RW;
