...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "modele_meteo_stm32"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (32)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (20)
